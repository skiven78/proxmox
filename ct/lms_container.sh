...
while true; do
    read -p "This will create a new Logitech Media Server LXC Container. Proceed (y/n)?" yn
    case $yn in
        [Yy]* ) break;;
        [Nn]* ) exit;;
...
wget -qL https://raw.githubusercontent.com/skiven78/proxmox/refs/heads/main/setup_files/lms_setup.sh
...
pct start $CTID
pct push $CTID lms_setup.sh /lms_setup.sh -perms 755
